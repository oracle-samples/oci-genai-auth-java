 ...
 *   <li>{@code serviceEndpoint} — service root; the caller-supplied {@code apiPath} is appended</li>
...
public final class OciEndpointResolver {
     ...
     * @param baseUrl         fully qualified URL override (used as-is when provided)
