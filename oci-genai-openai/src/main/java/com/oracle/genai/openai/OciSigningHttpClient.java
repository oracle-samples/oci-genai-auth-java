...
/**
 * An implementation of the OpenAI SDK's {@link HttpClient} interface backed by
 * an OCI-signed {@link okhttp3.OkHttpClient}.
 *
 * <p>This bridges the OpenAI SDK's HTTP abstraction with OCI request signing.
...
class OciSigningHttpClient implements HttpClient {
    ...
    /**
     * Adapts an OkHttp {@link Response} to the OpenAI SDK's {@link HttpResponse} interface.
     */
    private static class OkHttpResponseAdapter implements HttpResponse {
        ...
        OkHttpResponseAdapter(Response response) {
            ...
            // Convert OkHttp headers to SDK Headers
